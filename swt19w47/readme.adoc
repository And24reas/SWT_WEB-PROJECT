...
== Documentation
Have a look at https://st.inf.tu-dresden.de/SalesPoint/api/index.html[this] to see detailed information (functions, etc.) about the SalesPoint framework and its usage.
